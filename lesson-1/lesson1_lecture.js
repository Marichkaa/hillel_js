...
ідентифікатор, починаються з символу у верхньому регістрі. Використовується для оголошення класів, конструкторів і т. д.*/

// let FirstName, MinWidthValue, ErrorMessage

/* kebab-casing – кожне слово в ідентифікаторі відокремлюється дефісом та 
пишеться в нижньому регістрі. Використовується для назв файлів, стилів css, url адрес, конфігураційних файлів */
...
// console.log(text[text.length]); // Результат: 16
...
// let nameN = "Анна";
// let weekDay = "ЧЕТВЕР".toLowerCase();
// let message = `Привіт ${nameN}! Рада тебе бачити в цей ${weekDay}!`;
...
// const text = undefined; // За замовчуванням якщо змінна не ініціалізована, її значення Undefined
// console.log(text)
