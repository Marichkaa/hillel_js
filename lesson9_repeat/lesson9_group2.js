...
// // Напишіть regex, котрий знайде кількість чашок кави.
// let text = 'I would like 8 cups of coffee, please.';
...
/* 
    Завдання - 1:
    Напишіть сценарій, який виведе суму всіх елементів массиву.
*/
...
// let arr = [10, 20, 48, 6, 11, 9, 125, 1, 8, 0, 3, 255, 77, 11, 170, 4, 28];
